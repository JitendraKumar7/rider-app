...
import com.rch.rider.JsonUtil.AppOfferUtil.Category;
import com.rch.rider.JsonUtil.AppOfferUtil.Offer;
import com.rch.rider.JsonUtil.CardUtil.Card;
...
import com.rch.rider.JsonUtil.HomeUtil.Featured;
import com.rch.rider.JsonUtil.HomeUtil.HomeJson;
import com.rch.rider.JsonUtil.HomeUtil.Nearest;
import com.rch.rider.JsonUtil.HomeUtil.RestaurantStatus;
import com.rch.rider.JsonUtil.HomeUtil.Trending;
import com.rch.rider.JsonUtil.OrderHistoryUtil.OrderHistoryJson;
import com.rch.rider.JsonUtil.OrderHistoryUtil.OrderList;
import com.rch.rider.JsonUtil.OrderHistoryUtil.ProductOrderDetail;
import com.rch.rider.JsonUtil.OrderUtil.OrderJson;
import com.rch.rider.JsonUtil.ProductUtil.Product;
import com.rch.rider.JsonUtil.ProductUtil.ProductAttribute;
import com.rch.rider.JsonUtil.ProductUtil.ProductJson;
import com.rch.rider.JsonUtil.ReviewUtil.Review;
import com.rch.rider.JsonUtil.ReviewUtil.ReviewJson;
import com.rch.rider.JsonUtil.UserUtil.FavouriteList;
    ...
    public static DataObject getDataObject(RequestObject requestObject, Object data) {
        ...
        if (requestObject.getConnection() == Constant.CONNECTION.HOME) {
            ...
            for (int i = 0; i < categoryJson.getCategories().size(); i++) {
                ...
                com.rch.rider.JsonUtil.CategoryUtil.Category category =
